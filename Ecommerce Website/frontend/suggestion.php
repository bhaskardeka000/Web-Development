...
if(mysqli_num_rows($res)>0){
    echo "<div class='display_search_products' style='border: 0.1rem solid #ebebeb; border-top: none; position: absolute; z-index: 1000; width: 100%; max-height: 200px; overflow-y: scroll;'>";
...
echo "</div>";
    ...
    echo "<div class='display_search_products' style='border: 0.1rem solid #ebebeb; border-top: none; position: absolute; z-index: 1000; width: 100%;'>";
    echo "<a href='search.php?str=".$query."' class='list-group-item list-group-item-action border-1' style='font-size: 15px; border: none; padding-top: 10px; padding-bottom: 10px;'>".$query."</a>";
    echo "</div>";
}
?>