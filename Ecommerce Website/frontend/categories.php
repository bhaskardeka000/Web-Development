...
$cat_id = decrypt_id($cat_id);

$check_cat_id = mysqli_query($con, "select * from categories where id = '$cat_id' ");
if(mysqli_num_rows($check_cat_id)<1 || strpos($cat_id, ".") !== false || is_numeric($cat_id) === false){
?>
<script>
...
$cat_name = mysqli_fetch_assoc(mysqli_query($con, "select categories from categories where id = '$cat_id' "));
?>
    ...
    min-width: 165px;
      ...
      <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title"> <?php echo $cat_name['categories'] ?> </h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
            <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="categories.php?id=<?php echo encrypt_id($cat_id) ?>"><?php echo $cat_name['categories'] ?></a></li>
                    </ol>
                </div><!-- End .container -->
                				...
                				<div class="toolbox-right">
                					<div class="toolbox-sort">
                						...
                						<div class="select-custom">
											<select name="sortby" id="sort_product_id" class="form-control" onchange="sort_product_drop('<?php echo encrypt_id($cat_id) ?>', '<?php echo SITE_PATH_SORTING ?>')" style="color: black;">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3 col-xl-3 products_col">
                                        <div class="product product-7 text-center" onclick="location.href='products.php?id=<?php echo encrypt_id($list['id']) ?>'" style="cursor: pointer;">
                                            <figure class="product-media figure_categories_page">
